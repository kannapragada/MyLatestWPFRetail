namespace NewApp.Themes
{
    ...
    public static class ThemeManager
    {
        public static ResourceDictionary GetThemeResourceDictionary(string theme)
        {
            if (theme != null)
            {
                Assembly assembly = Assembly.LoadFrom("NewApp.Themes.dll");
                string packUri = String.Format(@"/NewApp.Themes;component/{0}/Theme.xaml", theme);
        ...
        public static string[] GetThemes()
        {
            ...
            { 
                "PlainVanilla", "NewVisualStudio", "WinXPTheme", "BlackBerry", "ExpressionDark", "BubbleCreme", "WhistlerBlue"

                //"ExpressionLight", "RainierOrange", "RainierPurple", "RainierRadialBlue", 
                //"ShinyBlue", "ShinyRed", "DavesGlossyControls", 
                //"BureauBlack", "BureauBlue", "TwilightBlue", "UXMusingsRed", "UXMusingsGreen", 
                //"UXMusingsRoughRed", "UXMusingsRoughGreen", "UXMusingsBubblyBlue"
            };
            return themes;
        }
